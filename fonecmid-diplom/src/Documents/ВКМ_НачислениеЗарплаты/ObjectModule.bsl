...
Процедура НачислитьПремию()
	...
	Запрос.Текст =
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВТ_СотрудникиИзДокумента.Сотрудник,
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ВКМ_ВыполненныеСотрудникомРаботы.Обороты(&ДатаНачала, &ДатаОкончания,,
		|			Сотрудник В
		|			(ВЫБРАТЬ
		|				ВТ_СотрудникиИзДокумента.Сотрудник
		|			ИЗ
		|				ВТ_СотрудникиИзДокумента)) КАК ВКМ_ВыполненныеСотрудникомРаботыОбороты
